    ...
    return rx.section(
        rx.desktop_only(
            rx.section(
                rx.vstack(
                    ...
                    rx.heading("Stay updated with latest heathcare news", size="8", weight="medium", color="black", margin_bottom="30px", align="center"),
                    rx.center(  # Added a center component
                        rx.vstack(
                            rx.scroll_area(
                                rx.foreach(
                                    NewsState.news_list,
                                    lambda news: news_card(news["title"], news["summary"], news["link"])
                                ),
                                type="always",
                                scrollbars="vertical",
        ...
        rx.mobile_and_tablet(
            ...
            rx.vstack(
                ...
                rx.heading("Stay updated with latest healhcare news", size="6", weight="medium", color="black", margin_bottom="10px", align="center"),
                rx.vstack(
                    rx.vstack(
                            rx.scroll_area(
                                rx.foreach(
                                    NewsState.news_list,
                                    lambda news: mobile_news_card(news["title"], news["summary"], news["link"])
                                ),
                                type="always",
                                scrollbars="vertical",
                                style={'height': "620px", 'width': '100%',}  # Added max-width
                            ),
                            width="100%",
                            align_items="center",
                        ),
